...
abstract class Controller extends BaseController
{
    ...
    public function restoreDataLog($request, $slug, $dataType, $data)
    {
        ...
        $request->request->add((array)$dataSectionLogContent,true);

        return $this->insertUpdateData($request, $dataTypeSection->slug, $dataTypeSection->rows, $dataSection) ? true : false;
    }
