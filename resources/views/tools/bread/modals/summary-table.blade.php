...
<form role="form" action="{{ route('voyager.bread.filter') }}" method="POST">
    <div class="modal fade modal-danger modal-relationships" id="summary_table">
            ...
            <div class="model-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-heart"></i> {{ str_singular(ucfirst($table)) }}
                        {{ __('voyager::bread.summary_table') }}
                    </h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 relationship_details">
                            ...
                            <select class="form-control">
                                @foreach(\TCG\Voyager\Models\DataType::all() as $val)
                ...
                <div class="modal-footer">
                    <div class="relationship-btn-container">
                        ...
                        @if(isset($dataType->id))
                            <button class="btn btn-danger btn-relationship"><i class="voyager-plus"></i> <span>{{ __('voyager::generic.add') }}</span></button>
                        @endif
                    </div>
                </div>
            </div>
